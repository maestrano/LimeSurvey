...
INSERT INTO `lime_settings_global` VALUES ('DBVersion','184'),('SessionName','=p-rZq&{LUD/eq!yy\"R#}!0MdO3$A^t]P#Q,tW(A-LPr>Pl8R?;P@J}&x2*;p}xA'),('sitename','LimeSurvey'),('siteadminname','Administrator'),('siteadminemail','your-email@example.net'),('siteadminbounce','your-email@example.net'),('defaultlang','en');
...
INSERT INTO `lime_users` VALUES (1,'admin','5e884898da28047151d0e56f8dc6292773603d0d6aabbdd62a11ef721d1542d8','Administrator',0,'en','your-email@example.net','default','default','default',NULL,1,'2015-09-18 13:24:06',NULL);
...
-- Dump completed on 2015-09-18 13:26:25
